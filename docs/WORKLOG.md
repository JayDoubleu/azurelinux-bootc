...
- Opened microsoft/azurelinux issue #18802 for the rpm-ostree 2026.1 bug. Recorded the owner's decisions: package stays private, empty repository and Azure test and desktop stay on the user's TODO.
...
- The arm64 CI job passed in 34 minutes under emulation. ghcr.io holds `latest-arm64` (arm64 65 13). The arm64 disk install and boot wait for the host packages.
