...
- aarch64. CI builds and pushes it since 2026-09-12. The disk install needs a native arm64 machine; user-mode emulation cannot run `bootc install`. Planned: the arm64 CI runner once the repository is public.
